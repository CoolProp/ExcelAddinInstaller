...
taskAddDirToPath=Add the installation directory to your PATH
taskInstallEES=Install CoolProp for Engineering Equation Solver (EES)
...
Deutsch.taskAddDirToPath=Den Installationspfad zu PATH hinzufügen
Deutsch.taskInstallEES=CoolProp für Engineering Equation Solver (EES) installieren
...
Dansk.taskAddDirToPath=Tilføje installationsmappen til PATH
Dansk.taskInstallEES=Installerer CoolProp for Engineering Equation Solver (EES)
